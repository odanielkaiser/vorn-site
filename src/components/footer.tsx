...
const services = [
  { label: "Infraestrutura Corporativa", href: "/servicos/infraestrutura" },
  ...
  { label: "VPN Corporativa", href: "/servicos/infraestrutura" },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            ...
            <p className="text-text-secondary text-sm leading-relaxed max-w-xs">
              Infraestrutura corporativa, segurança da informação e serviços
              gerenciados para pequenas e médias empresas. Tecnologia que
              transforma seu negócio.
            </p>
            <div className="flex gap-4 mt-6">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-primary/20 flex items-center justify-center transition-colors group"
                aria-label="LinkedIn"
              >
                <svg
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3 text-sm text-text-secondary">
              ...
              <li>
                <a
                  href="mailto:contato@vorntecnologia.com.br"
                  className="hover:text-primary transition-colors"
                >
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-secondary/50">
            &copy; {new Date().getFullYear()} Vorn Tecnologia. Todos os direitos
            reservados.
          </p>
